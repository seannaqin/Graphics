...
public class PolygonDemo extends Canvas
{
	public void paint( Graphics g )
	{
		...
		trap.addPoint(575,500);
		trap.addPoint(325, 500);
		g.fillPolygon(trap);
	}
...
/*
 * 1. Changing the order of the points in a pentagon will change its shape because the points are connected in chronological order
 * 
 */
